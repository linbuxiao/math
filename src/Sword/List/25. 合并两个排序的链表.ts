...
export function mergeTwoLists_1(l1: ListNode | null, l2: ListNode | null): ListNode | null {
  if(!l1) return l2
  if(!l2) return l1
...
// 构造新链表
export function mergeTwoLists_2(l1: ListNode | null, l2: ListNode | null): ListNode | null {
  let p = new ListNode()
  let cur = p
  let [p1, p2] = [l1,l2]
  while (p1 && p2) {
